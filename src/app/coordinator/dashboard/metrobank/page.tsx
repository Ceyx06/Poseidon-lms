...
export default function MetrobankPage() {
  ...
  function handleUpload() {
    ...
    setTimeout(() => {
      ...
      const input = document.getElementById("metrobankFile") as HTMLInputElement;
  ...
  function handleDelete(id: string) {
    if (confirm("Delete this Metrobank referral form?")) {
    ...
    <div style={{ fontFamily: "var(--font-dm)" }}>
      ...
      <div style={{ background: "#ffffff", borderRadius: "16px", border: "1.5px solid rgba(201,151,42,0.25)", padding: "24px", marginBottom: "24px", boxShadow: "0 4px 20px rgba(201,151,42,0.08)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
          ...
          <div>
            ...
            <input id="metrobankFile" type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={handleFileChange}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "24px" }}>
        {[
          ...
          { label: "PDF Files",    value: records.filter(r => r.fileName.endsWith(".pdf")).length,                  color: "#c0392b", bg: "#fff5f5" },
