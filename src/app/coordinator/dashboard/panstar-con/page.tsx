...
export default function PanstarContractPage() {
  const [records, setRecords] = useState<PanstarConRecord[]>([]);
  ...
  function handleUpload() {
    ...
    setTimeout(() => {
      ...
      const input = document.getElementById("panstarConFile") as HTMLInputElement;
  ...
  function handleDelete(id: string) {
    if (confirm("Delete this contract document?")) {
    ...
    <div style={{ fontFamily: "var(--font-dm)" }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "#6a85a0" }}>
          Upload and manage crew contract documents for PANSTAR vessels
        </p>
      </div>
      ...
      <div style={{ background: "#ffffff", borderRadius: "16px", border: "1.5px solid rgba(201,151,42,0.25)", padding: "24px", marginBottom: "24px", boxShadow: "0 4px 20px rgba(201,151,42,0.08)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
          ...
          <div>
            ...
            <input id="panstarConFile" type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={handleFileChange}
        ...
        {selectedFile && (
          <div style={{ marginBottom: "16px", padding: "10px 16px", borderRadius: "10px", background: "rgba(192,96,10,0.06)", border: "1px solid rgba(192,96,10,0.15)", display: "flex", alignItems: "center", gap: "10px" }}>
      ...
      <div style={{ background: "#ffffff", borderRadius: "16px", border: "1px solid #e8eef5", padding: "24px", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "50px 20px", color: "#a0b0c0" }}>
            ...
            <p style={{ fontSize: "14px", fontFamily: "var(--font-cinzel)", color: "#1a2d45", marginBottom: "8px" }}>No Contract Documents Yet</p>
            <p style={{ fontSize: "13px" }}>Use the upload form above to add the first contract.</p>
          </div>
        ) : (
