...
export default function ResumesPage() {
  ...
  return (
    <div style={{ fontFamily: "var(--font-dm)", padding: "4px" }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "#6a85a0" }}>
          Upload and manage crew resumes for JM Global deployment
        </p>
      </div>
      ...
      <div style={{ background: "#ffffff", borderRadius: "16px", border: "1.5px solid rgba(201,151,42,0.25)", padding: "24px", marginBottom: "20px", boxShadow: "0 4px 20px rgba(201,151,42,0.08)" }}>
        <h3 style={{ fontFamily: "var(--font-cinzel)", fontSize: "12px", fontWeight: "bold", color: "#8a6010", marginBottom: "16px", textTransform: "uppercase", letterSpacing: "0.1em" }}>
          📤 Upload Resume
        </h3>
        ...
        {selectedFile && (
          <div style={{ marginBottom: "14px", padding: "10px 14px", borderRadius: "10px", background: "rgba(26,107,191,0.06)", border: "1px solid rgba(26,107,191,0.15)", display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                {filtered.map((r, i) => (
                  <tr key={r.id} style={{ borderTop: "1px solid #f0f4f8", background: i % 2 === 0 ? "#ffffff" : "#fafbfd" }}>
                    ...
                    <td style={{ padding: "12px 14px", color: "#a0b0c0", fontSize: "11px", whiteSpace: "nowrap" }}>
                      {new Date(r.uploaded_at).toLocaleString("en-PH", { year: "numeric", month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" })}
                    </td>
